            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-gray-600">123 Tourism Street, Tashkent, Uzbekistan</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-gray-600">info@triptour.uz</p>
                  <p className="text-gray-600">support@triptour.uz</p>
                </div>
              </div>
            </div>
