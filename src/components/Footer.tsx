    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Trip Tour</h3>
            <p className="text-gray-400 mb-4">
              Discover the beauty and culture of Uzbekistan with our expertly crafted tours.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Tourism Street, Tashkent, Uzbekistan</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@triptour.uz</span>
              </li>
            </ul>
          </div>
        </div>
